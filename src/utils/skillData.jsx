...
export const Frontend_skills = [
  { skill_name: "React", Image: react, width: 80, height: 80 },
  ...
  { skill_name: "Framer Motion", Image: framer, width: 80, height: 80 },
];
...
export const Backend_skill = [
  ...
  { skill_name: "Node js", Image: node, width: 80, height: 80 },
  { skill_name: "Mongo db", Image: mongo, width: 40, height: 40 },
];

export const Full_stack = [
  { skill_name: "GitHub", Image: github, width: 70, height: 70 },
  { skill_name: "Git", Image: git, width: 70, height: 70 },
  { skill_name: "Docker", Image: docker, width: 70, height: 70 },
];
